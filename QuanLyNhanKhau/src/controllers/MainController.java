    ...
    public void setView(JPanel jpnItem, JLabel jlbItem, String kind) {
        ...
        switch(kind) {
                ...
                case "ThongKe":
                    ...
                    break;
                case "QuanLy":
                    view = new QuanLyCoSoVatChatPanel(this.jfrMain);
                    break;
                //any more
                case "DangKy":
                    view = new DangKyPanel(this.jfrMain);
                    break;
                case "LichSu":
